...
import skripsi.edwin.filkomapps.jadwalUjian.presenter.presenterJadwalTerbaru.ResultSearchContract;
import skripsi.edwin.filkomapps.jadwalUjian.presenter.presenterJadwalTerbaru.ResultSearchPresenter;
import skripsi.edwin.filkomapps.jadwalUjian.view.adapter.JadwalAdapter;
import skripsi.edwin.filkomapps.model.JadwalUjian;

public class ResultSearchActivity extends AppCompatActivity implements ResultSearchContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultSearchPresenter=new ResultSearchPresenter(this,this);
    ...
    public void setJadwal(List<JadwalUjian> jadwalUjian) {
        ...
        adapter=new JadwalAdapter(this,jadwalUjian);
