...
import skripsi.edwin.filkomapps.jadwalUjian.presenter.presenterRiwayat.ListRiwayatContract;
import skripsi.edwin.filkomapps.jadwalUjian.presenter.presenterRiwayat.ListRiwayatPresenter;
 ...
 */
public class ListRiwayatUjianFragment extends Fragment implements ListRiwayatContract.View, SearchView.OnQueryTextListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_riwayat_ujian, container, false);
    }
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        ButterKnife.bind(this,view);
        riwayatPresenter=new ListRiwayatPresenter(getActivity(),this);
        riwayatPresenter.getJadwal();
        ...
        builder.setTitle("Peran")
                ...
                .setPositiveButton("Terapkan", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        riwayatPresenter.filterJadwal(seletedItems,searchView.getQuery().toString());
                    }
                }).show();
    }
    @Override
    ...
    public void setFilterJadwal(List<JadwalUjian> jadwalUjian) {
        ...
        adapter=new RiwayatAdapter(getActivity(),jadwalUjian);
    ...
    public boolean onQueryTextSubmit(String query) {
        Intent intent=new Intent(getActivity(),ResultSearchRiwayatActivity.class);
