...
public class DeskripsiPenilaianKomponen4 {
    Context context;
    public DeskripsiPenilaianKomponen4(Context context) {
        this.context = context;
    }

    public String getDeskripsiKeterangan1(int progress) {
        String desc1[] = context.getResources().getStringArray(R.array.desc4_1_1);
        return  desc1[progress-1];

    }

    public String getDeskripsiKeterangan2(int progress) {
        String desc2[]=context.getResources().getStringArray(R.array.desc4_2_2);
    ...
    public String getDeskripsiKeterangan3(int progress) {
        String desc3[]=context.getResources().getStringArray(R.array.desc4_3_3);
        return  desc3[progress-1];

    }

    public String getDeskripsiKeterangan4(int progress) {
        String desc4[]=context.getResources().getStringArray(R.array.desc4_4_4);
